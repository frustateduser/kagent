...
from news import make_news_request
...
mcp = FastMCP(
    name="news_mcp",
    instructions="you are a news agent, you can use tools to get news from the internet, and summarize them for users. Always use tools to get news, never make up news. If you can't find any news, just say you can't find any news."
)
...
async def search_news(
    ...
    try:
        result = await make_news_request("search", params)
        return {
            "success": True,
            "query": q,
...
async def get_top_headlines(
    ...
    try:
        result = await make_news_request("top-headlines", params)
        return {
            "success": True,
